          ...
          <div className="flex items-center gap-2 mb-2">
            <div className="flex items-center gap-1">
              {availableAngles.map((angle) => {
                // Check if angle is disabled in triple view (no custom track)
                const isDisabledInTriple = layout === 'triple' && !hasCustomCameraTrack && !tripleViewAngles.includes(angle);
            ...
            {layout === 'triple' && !hasCustomCameraTrack && (
